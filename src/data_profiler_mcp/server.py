...
def profile_dataset(path: str, max_rows: int | None = None) -> dict:
    ...
    head sample.
    """
    return profiling.profile_dataset(path, max_rows=max_rows)
...
def column_stats(path: str, column: str, max_rows: int | None = None) -> dict:
    ...
    not found.
    """
    return profiling.column_stats(path, column, max_rows=max_rows)
...
def detect_quality_issues(path: str, max_rows: int | None = None) -> dict:
    ...
    (whitespace-only) strings. Each issue carries a column (or ``null`` for
    ...
    """
    return profiling.detect_quality_issues(path, max_rows=max_rows)
...
def suggest_dtypes(path: str, max_rows: int | None = None) -> dict:
    ...
    """
    return profiling.suggest_dtypes(path, max_rows=max_rows)
...
def compare_datasets(path_a: str, path_b: str, max_rows: int | None = None) -> dict:
    ...
    """
    return profiling.compare_datasets(path_a, path_b, max_rows=max_rows)
